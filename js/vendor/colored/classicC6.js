...
const list =['#FF0000','#00FF00','#0000FF','#BBBBBB','#444444','#000000'];
const board = [];
let rightBoard=[];
...
function startTimerFromPrompt() {
  ...
  if (isNaN(timeSpan) || timeSpan <= 0||lifes === 27) {
    return;
  }
